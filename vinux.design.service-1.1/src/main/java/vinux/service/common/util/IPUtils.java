	...
	public static Map<String, String> getAddress(String ip) {
		...
		if (returnStr != null) {
			...
			if ("0".equals(json.get("code").toString())) {
				...
				map.put("country", decodeUnicode(json.optJSONObject("data")
						.getString("country")));// 国家
				map.put("area", decodeUnicode(json.optJSONObject("data")
						.getString("area")));// 地区
				map.put("province", decodeUnicode(json.optJSONObject("data")
						.getString("region")));// 省份
				map.put("city", decodeUnicode(json.optJSONObject("data")
						.getString("city")));// 市区
				map.put("county", decodeUnicode(json.optJSONObject("data")
						.getString("county")));// 地区
				map.put("isp", decodeUnicode(json.optJSONObject("data")
						.getString("isp")));// ISP公司
