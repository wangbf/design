...
public class JDBCConfig {
	...
	static{
		prop = new Properties();
		try {
			prop.load(JDBCConfig.class.getResourceAsStream(FILE_NAME));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public static String getProperty(String key){
		...
		LoggerUtils.debug(JDBCConfig.class, String.format("jdbc.properties.通过Key[%s],获取到的Value[%s]", key,value));
		return value;
	}
}
