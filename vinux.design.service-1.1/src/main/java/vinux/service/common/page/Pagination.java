package vinux.service.common.page;

import java.util.List;

import vinux.service.core.page.Paginable;
import vinux.service.core.page.SimplePage;
...
public class Pagination<T> extends SimplePage implements java.io.Serializable,
	...
	public String getPageHtml(){
		StringBuffer pageHtml = new StringBuffer("<ul>");
		if(this.getPageNo()>1){
			if(this.getPageNo()>5){
