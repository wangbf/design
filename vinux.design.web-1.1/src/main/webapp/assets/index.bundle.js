...
/***/ function(module, exports, __webpack_require__) {
	...
	function initCustomRequires() {
		...
		var GlobalSettingModal = __webpack_require__(51),
			SetLinkImageModal = __webpack_require__(52),
			UploadModal = __webpack_require__(57),
			SetNavBarModal = __webpack_require__(58),
			SetLunboModal = __webpack_require__(60),
			SetBoxModal = __webpack_require__(62);
		...
		if ('shop' == instanceType) {
			var SelectProductView = __webpack_require__(48);
	...
	//			this.listenTo(ModuleCollection, 'update', function() {alert('update')});
				this.listenTo(ModuleCollection, 'all', this.render);
				this.listenTo(ModuleCollection, 'reset', this.addAll);
			 	ModuleCollection.fetch($('#pageId').val());
			},
			addAll: function() {
				this.$el.empty();
				var that = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	//		this.trigger('update');
		...
		fetch: function(pageId) {
			...
			var index;
			$.ajax({
				url: '/main/page/' + pageId + '/data.vhtml',
				cache: false,
				dataType: 'json',
				beforeSend: function() {
				...
				success: function(res) {
					self.pageModel = res;
					if (res.data) {
						self.reset(JSON.parse(res.data));
					} 
				},
				complete: function() {
					layer.close(index);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(1);
	var ProductItemTemplate = __webpack_require__(49),
		CategoryItemTemplate = __webpack_require__(50);
...
/***/ function(module, exports) {
	...
	module.exports = "\r\n<a href=\"javascript:void(0)\" class=\"\">\r\n\t<img alt=\"image\" class=\"img-circle-4 pull-left m10right\" width=\"35\" height=\"35\" src=\"<%= image %>\">\r\n\t<div class=\"media-body \">\r\n\t\t<small><%= title %></small><br>\r\n\t\t<small class=\"text-muted\">￥<%= price %> <!-- 报销比例：<%= fund %> --></small>\r\n\t\t<% if (hasAdd) {%>\r\n\t\t\t<label class=\"label label-warning pull-right\"><i class=\"fa fa-check\"></i> 已添加</label>\r\n\t\t<% } %>\r\n\t</div>\r\n</a>\r\n";

/***/ },
/* 50 */
/***/ function(module, exports) {

	module.exports = "<a href=\"javascript:void(0);\" class=\"chat-user \"> \r\n\t<div class=\"chat-user-name fl\"> <%= name %> </div>\t\t\t\t\t\r\n</a>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	//		});
			__webpack_require__.e/* require */(2, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(61)]; (function(Pagination) {
