		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span9">
					...
					<form id="edit-profile" class="form-horizontal" action="/demo/saveOrUpdate.vhtml" method="post">
						<fieldset>
							<legend>Your Profile</legend>
							<div class="control-group">
								<label class="control-label" for="input01">姓名</label>
								<div class="controls">
									<input type="hidden" name="id" class="input-xlarge" id="input01" value="${demo.id}" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="school" class="input-xlarge" id="input01"placeholder="请输入学校" check="请输入学校" value="${demo.school?default('')}" />
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="address" class="input-xlarge" id="input01"  placeholder="请输入地址" check="请输入地址" value="${demo.address?default('')}" />
								</div>
							</div>
